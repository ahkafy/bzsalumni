...
<body>
  ...
  <div class="d-flex header" style="#f0f0f0">
    ...
    <section class="post-nav header-padding">
        <div class="container-fluid p-4">
            <div class="row">
                <div class="col-5">
                    <img src="{{ url('bzs.png') }}" style="position:absolute" alt="">
                </div>
                <div class="col-7">
                    <h2 class="text-white bangla ">প্রজন্মের সেতুবন্ধন </h2>
                    <h1 class="text-white bangla ">বগুড়া জিলা স্কুল অ্যালামনাই অ্যাসোসিয়েশন</h1>
                </div>
            </div>
        </div>
    </section>

    <div class="container-fluid header-padding" style="min-height: 600px">
        <div class="row">
            <div class="offset-3 pt-4 pr-4">
                <p class="text-justify bangla" style="font-size:20px">
                    বগুড়া জিলা স্কুল বগুড়া শহরের প্রাণকেন্দ্র সাতমাথায় অবস্থিত। স্কুলের পূর্ব পাশে সার্কিট হাউস এবং দক্ষিণ পাশে আলতাফুন্নেসা খেলার মাঠ অবস্থিত। স্কুলের সামনেই উত্তরপার্শ্বে কেন্দ্রীয় জেলা পোস্ট অফিস। উত্তরবঙ্গের প্রাণকেন্দ্র বগুড়া, আর বগুড়ার প্রাণকেন্দ্র সাতমাথায় অবস্থিত “বগুড়া জিলা স্কুল, বগুড়া”। স্ব-নামোজ্জ্বল, স্ব-মহিমায় ভাস্বর, ঐতিহ্যমন্ডিত ফুলের বাগান স্বরূপ এই বিদ্যাপীঠটি যুগের সাথে তাল মিলিয়ে দক্ষ মানব সম্পদ গঠন ও তাদের উন্নয়নের লক্ষ্যে বগুড়াবাসী এই বিদ্যালয়কে যে গুরু দায়িত্ব দিয়েছিল তা যথাযথ ভাবে পালনের মাধ্যমে আজও সে প্রতিরোধ্য ও অপ্রতিদ্বন্দ্বী। তাই এই বিদ্যালয় প্রতিষ্ঠা লাভের পর থেকে শ্রেষ্ঠত্ত্বের যে মণিমুকুট তার মাথায় শোভিত হয়েছিল আজ অবধি সেই মুকুট উজ্জ্বল, অম্লান, অমলিন। আজও সে মুকুট থেকে বেরিয়ে আসছে মহা সম্মান এবং সাফল্যের দ্যূতি ও ঝলক।
                </p>
            </div>
        </div>
    </div>
